...
angular.module('app.selfwork').controller('SelfWorkEditorJobCtrl', function ($scope, $stateParams, $state, AuthApi, Session, toaster, $uibModal, $templateCache) {
    ...
    angular.extend(this, {
        ...
        editorOrderOptions : {
            ...
            columnDefs: [
                ...
                { name: 'b',        displayName: '清關條碼(袋號)', width: 129 },
                { name: 'c',        displayName: '提單號(小號)', width: 115 },
